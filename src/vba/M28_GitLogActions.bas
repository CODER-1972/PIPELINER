...
'   - Adiciona criacao/refresh da coluna Eliminar com hyperlink para GitLog_DeleteEntry.
...
Private Sub GitLog_UpsertDeleteButton(ByVal ws As Worksheet, ByVal targetRow As Long, ByVal targetCol As Long)
    ...
    shpName = "BTN_GITLOG_DELETE_" & Format$(targetRow, "00000")

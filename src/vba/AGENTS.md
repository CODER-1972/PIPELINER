...
- Na status bar do PAINEL (`Row n de z`), a contagem deve usar índice lógico de prompts válidos e tolerar listas esparsas (STOP/lacunas intermédias), para evitar regressões visuais do tipo `Row 1 de 1` quando existem IDs abaixo.

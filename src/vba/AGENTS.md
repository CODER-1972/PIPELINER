...
- Antes de enviar payload para `/v1/responses`, executar preflight de JSON para detetar caracteres de controlo não escapados dentro de strings (causa típica de `invalid_json`) e registar posição + escape sugerido no DEBUG (`\n`, `\r`, `\t`, `\u00XX`).

...
' - Expor getters tipados para par̢metros de robustez HTTP.
'
' Atualiza̵̤es:
...
'   - Exp̵e helper GH_Config_GetLong com fallback seguro para retrocompatibilidade.
...
'   - L̻ valor num̩rico de configura̤̣o com fallback seguro.
' =============================================================================
